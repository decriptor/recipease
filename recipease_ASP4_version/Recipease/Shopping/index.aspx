...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <div id="onecolumn">
        ...
        <div>
            ...
            <asp:TableRow>
                ...
                <asp:TableCell>
                   ...
                   <asp:HyperLink ID="HyperLink1" runat="server" CssClass="removeX" NavigateUrl="~/Shopping/index.aspx" ToolTip="Remove Item"> X </asp:HyperLink>&nbsp;
                </asp:TableCell>
            ...
            <asp:TableRow>
                ...
                <asp:TableCell>
                   ...
                   Width="70px" SkinID="SmallestText">Change Amt</asp:TextBox>&nbsp;&nbsp;
                <asp:HyperLink ID="HyperLink2" runat="server" CssClass="removeX" NavigateUrl="~/Shopping/index.aspx" ToolTip="Remove Item"> X </asp:HyperLink>&nbsp;
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                ...
                <asp:TableCell>
                   ...
                   Width="70px" SkinID="SmallestText">Change Amt</asp:TextBox>&nbsp;&nbsp;
                    <asp:HyperLink ID="HyperLink3" runat="server" CssClass="removeX" NavigateUrl="~/Shopping/index.aspx" ToolTip="Remove Item"> X </asp:HyperLink>&nbsp;
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
        </div><br /><br />
        <div style="margin-top: 150px;">
            <!-- Add item section -->
            <asp:HyperLink ID="HyperLink21" runat="server" CssClass="addMore" NavigateUrl="~/Shopping/index.aspx">[ + ] Add an item</asp:HyperLink><br /><br />
