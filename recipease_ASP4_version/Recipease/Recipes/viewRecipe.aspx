...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <p>
        <!-- This page is under construction for formatting.<br /> -->
        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Recipes/index.aspx">Return to recipes</asp:HyperLink><br />
    </p>  
    ...
    <asp:SqlDataSource ID="TagsSDS" runat="server" 
        ConnectionString="<%$ ConnectionStrings:INFO3420_12ConnectionString %>" 
        SelectCommand="SELECT RECIPEASE_TAG.tag_name AS [Tags] FROM RECIPEASE_RECIPE_TAG INNER JOIN RECIPEASE_TAG ON RECIPEASE_RECIPE_TAG.tag_id = RECIPEASE_TAG.tag_id 
                        WHERE (RECIPEASE_RECIPE_TAG.rec_id = @rec_id)
                        ORDER BY RECIPEASE_TAG.tag_name">
        <SelectParameters>
            <asp:QueryStringParameter Name="rec_id" QueryStringField="rec_id" 
                Type="Int32" />
        </SelectParameters>
    ...
    <asp:FormView ID="FormView1" runat="server" BackColor="White" 
        ...
        <ItemTemplate>
        <asp:Image ID="imgRecipe" runat="server" ImageUrl='<%# Eval("rec_image_path") %>' /><br /><br />
        <table>
        <tr>
        ...
        <tr>
            <td>
                <asp:Label ID="ratingHEADER" runat="server" SkinID="recipeLabelHeader" Text="Rating (/5) "></asp:Label><br />
        ...
        <tr>
            <td>
                <br /><asp:Label ID="ingredientsHEADER" runat="server" SkinID="recipeLabelHeader" Text="Ingredients"></asp:Label><br />
            </td>
        </tr>
        ...
        <asp:GridView ID="GridView1" runat="server" DataSourceID="IngredientsSDS" 
            ...
            CellPadding="4" ForeColor="Black" GridLines="Vertical" AllowSorting="false">
        ...
        <tr>
            <td>
                <br /><asp:Label ID="directionsHEADER" runat="server" SkinID="recipeLabelHeader" Text="Directions"></asp:Label><br />
