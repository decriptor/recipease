        ...
        <h1>My Food Pantry</h1>
            <span class="emphasis">Boxed</span> <hr />
                ...
                <asp:TextBox ID="TextBox1" runat="server" Height="25px" Width="200px">Oatmeal</asp:TextBox>&nbsp;
                    ...
                    <asp:HyperLink ID="HyperLink1" runat="server" CssClass="removeX" NavigateUrl="~/pantry.aspx" ToolTip="Remove Item"> X </asp:HyperLink>&nbsp;
                ...
                <asp:TextBox ID="TextBox3" runat="server" Height="25px" Width="200px">Item</asp:TextBox>&nbsp; 
                    ...
                    <asp:HyperLink ID="HyperLink2" runat="server" CssClass="removeX" NavigateUrl="~/pantry.aspx" ToolTip="Remove Item"> X </asp:HyperLink><br />
                ...
                <asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="~/Images/barcode_icon_2.jpg" ToolTip="Scan Item" />&nbsp;
                    <asp:HyperLink ID="HyperLink3" runat="server" CssClass="removeX" NavigateUrl="~/pantry.aspx" ToolTip="Remove Item"> X </asp:HyperLink>&nbsp;
                ...
                <asp:ImageButton ID="ImageButton4" runat="server" ImageUrl="~/Images/barcode_icon_2.jpg" ToolTip="Scan Item" />&nbsp;
                    <asp:HyperLink ID="HyperLink4" runat="server" CssClass="removeX" NavigateUrl="~/pantry.aspx" ToolTip="Remove Item"> X </asp:HyperLink>
                    <asp:HyperLink ID="HyperLink21" runat="server" CssClass="addMore moveright smallpad" NavigateUrl="~/pantry.aspx">[ + ] add more</asp:HyperLink><br /><br />
            <span class="emphasis">Canned</span> <hr />
                ...
                <asp:TextBox ID="TextBox9" runat="server" Height="25px" Width="200px">Corn, Whole Kernal</asp:TextBox>&nbsp;
                    ...
                    <asp:HyperLink ID="HyperLink17" runat="server" CssClass="removeX" NavigateUrl="~/pantry.aspx" ToolTip="Remove Item"> X </asp:HyperLink>&nbsp;
                ...
                <asp:TextBox ID="TextBox11" runat="server" Height="25px" Width="200px">Item</asp:TextBox>&nbsp; 
                    ...
                    <asp:HyperLink ID="HyperLink5" runat="server" CssClass="removeX" NavigateUrl="~/pantry.aspx" ToolTip="Remove Item"> X </asp:HyperLink><br />
                ...
                <asp:ImageButton ID="ImageButton6" runat="server" ImageUrl="~/Images/barcode_icon_2.jpg" ToolTip="Scan Item" />&nbsp;
                    <asp:HyperLink ID="HyperLink6" runat="server" CssClass="removeX" NavigateUrl="~/pantry.aspx" ToolTip="Remove Item"> X </asp:HyperLink>&nbsp;
                ...
                <asp:ImageButton ID="ImageButton7" runat="server" ImageUrl="~/Images/barcode_icon_2.jpg" ToolTip="Scan Item" />&nbsp;
                    <asp:HyperLink ID="HyperLink7" runat="server" CssClass="removeX" NavigateUrl="~/pantry.aspx" ToolTip="Remove Item"> X </asp:HyperLink>    
                    <asp:HyperLink ID="HyperLink22" runat="server" CssClass="addMore moveright smallpad" NavigateUrl="~/pantry.aspx">[ + ] add more</asp:HyperLink><br /><br />
            <span class="emphasis">Meat</span> <hr />
                ...
                <asp:TextBox ID="TextBox17" runat="server" Height="25px" Width="200px">Chicken Breast, Boneless</asp:TextBox>&nbsp;
                    ...
                    <asp:HyperLink ID="HyperLink18" runat="server" CssClass="removeX" NavigateUrl="~/pantry.aspx" ToolTip="Remove Item"> X </asp:HyperLink>&nbsp;
                ...
                <asp:TextBox ID="TextBox19" runat="server" Height="25px" Width="200px">Item</asp:TextBox>&nbsp; 
                    ...
                    <asp:HyperLink ID="HyperLink8" runat="server" CssClass="removeX" NavigateUrl="~/pantry.aspx" ToolTip="Remove Item"> X </asp:HyperLink><br />
                ...
                <asp:ImageButton ID="ImageButton9" runat="server" ImageUrl="~/Images/barcode_icon_2.jpg" ToolTip="Scan Item" />&nbsp;
                    <asp:HyperLink ID="HyperLink9" runat="server" CssClass="removeX" NavigateUrl="~/pantry.aspx" ToolTip="Remove Item"> X </asp:HyperLink>&nbsp;
                ...
                <asp:ImageButton ID="ImageButton10" runat="server" ImageUrl="~/Images/barcode_icon_2.jpg" ToolTip="Scan Item" />&nbsp;
                    <asp:HyperLink ID="HyperLink10" runat="server" CssClass="removeX" NavigateUrl="~/pantry.aspx" ToolTip="Remove Item"> X </asp:HyperLink>
                    <asp:HyperLink ID="HyperLink23" runat="server" CssClass="addMore moveright smallpad" NavigateUrl="~/pantry.aspx">[ + ] add more</asp:HyperLink><br /><br />        
            <span class="emphasis">Dairy</span> <hr />
                ...
                <asp:TextBox ID="TextBox25" runat="server" Height="25px" Width="200px">Sour Cream</asp:TextBox>&nbsp;
                    ...
                    <asp:HyperLink ID="HyperLink19" runat="server" CssClass="removeX" NavigateUrl="~/pantry.aspx" ToolTip="Remove Item"> X </asp:HyperLink>&nbsp;
                ...
                <asp:TextBox ID="TextBox27" runat="server" Height="25px" Width="200px">Item</asp:TextBox>&nbsp; 
                    ...
                    <asp:HyperLink ID="HyperLink11" runat="server" CssClass="removeX" NavigateUrl="~/pantry.aspx" ToolTip="Remove Item"> X </asp:HyperLink><br />
                ...
                <asp:ImageButton ID="ImageButton12" runat="server" ImageUrl="~/Images/barcode_icon_2.jpg" ToolTip="Scan Item" />&nbsp;
                    <asp:HyperLink ID="HyperLink12" runat="server" CssClass="removeX" NavigateUrl="~/pantry.aspx" ToolTip="Remove Item"> X </asp:HyperLink>&nbsp;
                ...
                <asp:ImageButton ID="ImageButton13" runat="server" ImageUrl="~/Images/barcode_icon_2.jpg" ToolTip="Scan Item" />&nbsp;
                    <asp:HyperLink ID="HyperLink13" runat="server" CssClass="removeX" NavigateUrl="~/pantry.aspx" ToolTip="Remove Item"> X </asp:HyperLink>
                    <asp:HyperLink ID="HyperLink24" runat="server" CssClass="addMore moveright smallpad" NavigateUrl="~/pantry.aspx">[ + ] add more</asp:HyperLink><br /><br />  
            <span class="emphasis">Vegetables</span> <hr />
                ...
                <asp:TextBox ID="TextBox33" runat="server" Height="25px" Width="200px">carrots, frozen</asp:TextBox>&nbsp;
                    ...
                    <asp:HyperLink ID="HyperLink20" runat="server" CssClass="removeX" NavigateUrl="~/pantry.aspx" ToolTip="Remove Item"> X </asp:HyperLink>&nbsp;
                ...
                <asp:TextBox ID="TextBox35" runat="server" Height="25px" Width="200px">Item</asp:TextBox>&nbsp; 
                    ...
                    <asp:HyperLink ID="HyperLink14" runat="server" CssClass="removeX" NavigateUrl="~/pantry.aspx" ToolTip="Remove Item"> X </asp:HyperLink><br />
                ...
                <asp:ImageButton ID="ImageButton15" runat="server" ImageUrl="~/Images/barcode_icon_2.jpg" ToolTip="Scan Item" />&nbsp;
                    <asp:HyperLink ID="HyperLink15" runat="server" CssClass="removeX" NavigateUrl="~/pantry.aspx" ToolTip="Remove Item"> X </asp:HyperLink>&nbsp;
                ...
                <asp:ImageButton ID="ImageButton16" runat="server" ImageUrl="~/Images/barcode_icon_2.jpg" ToolTip="Scan Item" />&nbsp;
                    <asp:HyperLink ID="HyperLink16" runat="server" CssClass="removeX" NavigateUrl="~/pantry.aspx" ToolTip="Remove Item"> X </asp:HyperLink>
                    <asp:HyperLink ID="HyperLink25" runat="server" CssClass="addMore moveright smallpad" NavigateUrl="~/pantry.aspx">[ + ] add more</asp:HyperLink><br /><br />
